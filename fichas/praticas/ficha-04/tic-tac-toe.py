...
# Função que verifica se um determinado jogador ganhou
...
def minimax(estado, profundidade, jogador):
    ...
    for x, y in celulas_vazias(estado):
        ...
        # recursive call
        if jogador == HUMANO:
            out = minimax(estado, profundidade-1, BOT)
        else:
            out = minimax(estado, profundidade - 1, HUMANO)
...
# Função responsável por imprimir o jogo para a consola
